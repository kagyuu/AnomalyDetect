...
| モジュール | 内容 | U001 | U002 | U003 | U004 | U005 | U006 | U007 | U008 |
| --- | --- | :-: | :-: | :-: | :-: | :-: | :-: | :-: | :-: |
| M01 `cli` | 引数解析・全体制御・終了コード | ◯骨格 | | | | | | | ●完成 |
| M02 `config` | 設定の読み込みと検証 | ● | | | | | | | |
| M03 `discovery` | ファイル探索と種別判定 | | ● | | | | | | |
| M04 `loaders.dbconn` | ① の解析 | | ● | | | | | | |
| M05 `loaders.jstat` | ② の解析(形式判別) | | ● | | | | | | |
| M06 `loaders.bqueues` | ③ の解析(横→縦) | | ● | | | | | | |
| M07 `metrics` | 統一ビュー構築 | | | | ● | | | | |
| M08 `detectors` | 10 アルゴリズム(※CR-005 後は 11) | | | | | ●A1-A5 | ●B1-B5 | | |
| M09 `events` | 統合・脅威度 | | | | | | | ● | |
| M10 `causes` | 原因候補 | | | | | | | ● | |
| M11 `correlate` | 相関情報 | | | | | | | ● | |
| M12 `reporter` | `report.md` 生成 | | | | | | | | ● |
| M13 `progress` | 進捗ログ | ● | | | | | | | |
| M14 `bootstrap` | vendor 解決・DuckDB 初期化 | ● | | | | | | | |
| `errors` | 例外クラスと終了コードの対応 | ● | | | | | | | |
| `schema` | DDL | ● | | | | | | | |
| `tools/gen_testdata` | テストデータ生成 | | | ● | | | | | |

**全 14 モジュール + `errors` + `schema` + 生成ツールが、いずれかのスプリントに割り当てられている。漏れなし。**
